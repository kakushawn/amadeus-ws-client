...
use Amadeus\Client\RequestOptions\FareInstantTbSearchOptions;
...
/**
 * InstantTravelBoardSearch
 *
 * @package Test\Amadeus\Client\Struct\Fare
 * @author Dieter Devlieghere <dermikagh@gmail.com>
 */
class InstantTravelBoardSearchTest extends BaseTestCase
{
    public function testCanMakeBaseMasterPricerMessage()
    {
        $opt = new FareInstantTbSearchOptions();
        ...
        $message = new InstantTravelBoardSearch($opt);
    ...
    public function testCanMakeMasterPricerMessageWithCabinClass()
    {
        ...
        $opt->cabinClass = FareInstantTbSearchOptions::CABIN_ECONOMY_PREMIUM;


        $message = new InstantTravelBoardSearch($opt);

        $this->assertEquals(FareInstantTbSearchOptions::CABIN_ECONOMY_PREMIUM, $message->travelFlightInfo->cabinId->cabin);
    ...
    public function testCanMakeMasterPricerMessageWithCabinClassAndCod()
    {
        ...
        $opt->cabinClass = FareInstantTbSearchOptions::CABIN_ECONOMY_PREMIUM;
        $opt->cabinOption = FareInstantTbSearchOptions::CABINOPT_RECOMMENDED;
    ...
    public function testCanMakeMessageWithFlightType()
    {
        $opt = new FareInstantTbSearchOptions([
            ...
            'requestedFlightTypes' => [
                FareInstantTbSearchOptions::FLIGHTTYPE_DIRECT
            ]
        ]);
    ...
    public function testCanMakeMessageWithPreferredAirlines()
    {
        $opt = new FareInstantTbSearchOptions([
            ...
            'airlineOptions' => [
                FareInstantTbSearchOptions::AIRLINEOPT_PREFERRED => ['BA', 'SN']
            ]
        ]);
    ...
    public function testCanMakeMessageWithPublishedUnifaresCorporateUnifares()
    {
        $opt = new FareInstantTbSearchOptions([
            ...
            'flightOptions' => [
                FareInstantTbSearchOptions::FLIGHTOPT_PUBLISHED,
                FareInstantTbSearchOptions::FLIGHTOPT_UNIFARES,
                FareInstantTbSearchOptions::FLIGHTOPT_CORPORATE_UNIFARES,
            ],
            'corporateCodesUnifares' => ['123456'],
            'corporateQualifier' => FareInstantTbSearchOptions::CORPORATE_QUALIFIER_UNIFARE
        ]);
        ...
        $this->assertEquals(FareInstantTbSearchOptions::CORPORATE_QUALIFIER_UNIFARE, $message->fareOptions->corporate->corporateId[0]->corporateQualifier);
    }
    ...
    {
        $msg = new InstantTravelBoardSearch(
            new FareInstantTbSearchOptions([
                'nrOfRequestedPassengers' => 1,
                'passengers' => [
                    new MPPassenger([
                        'type' => MPPassenger::TYPE_ADULT,
    ...
    public function testCanMakeMessageWithAirlinesIncludedExcludedSegmentLevel()
    {
        $msg = new InstantTravelBoardSearch(
            new FareInstantTbSearchOptions([
                ...
                'airlineOptions' => [
                    FareInstantTbSearchOptions::AIRLINEOPT_MANDATORY => [
                        'AF',
                        'YY',
                    ]
                ],
    ...
    public function testCanMakeMessageWithFlightCategory()
    {
        $msg = new InstantTravelBoardSearch(
            new FareInstantTbSearchOptions([
                ...
                'requestedFlightTypes' => [
                    FareInstantTbSearchOptions::FLIGHTTYPE_NONSTOP,
                    FareInstantTbSearchOptions::FLIGHTTYPE_DIRECT
                ],
                'itinerary' => [
                    new MPItinerary([
    ...
    public function testCanSpecifyCabinPerItinerary()
    {
        ...
        $opt->itinerary[] = new MPItinerary([
            ...
            'arrivalLocation' => new MPLocation(['city' => 'LON']),
            'date' => new MPDate(['dateTime' => new \DateTime('2017-01-15T00:00:00+0000', new \DateTimeZone('UTC'))]),
            'cabinClass' => FareInstantTbSearchOptions::CABIN_ECONOMY_PREMIUM
        ]);

        $message = new InstantTravelBoardSearch($opt);

        $this->assertEquals(FareInstantTbSearchOptions::CABIN_ECONOMY_PREMIUM, $message->itinerary[0]->flightInfo->cabinId->cabin);
